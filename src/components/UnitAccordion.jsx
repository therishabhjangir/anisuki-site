...
/**
 * Simple, validated accordion for units.
 * Renders optional topics list with external links.
 */
            ...
            >
              ...
              <div
                className={
                  ...
                  (isOpen
                    ? "transform rotate-45 bg-slate-100 text-slate-700"
            ...
            {isOpen && (
              <div className="px-5 py-4 bg-slate-50 dark:bg-slate-900 text-slate-700 dark:text-slate-200 space-y-4">
                ...
                {Array.isArray(u.topics) && u.topics.length > 0 && (
                  <div>
                    <h5 className="text-sm font-semibold mb-2 text-slate-700 dark:text-slate-200">
                      Topics
                    </h5>
